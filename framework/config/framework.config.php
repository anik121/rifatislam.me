...
// ===============================================================================================
$settings           = array(
  'menu_title'      => 'MixPro Theme',
  'menu_type'       => 'menu', // menu, submenu, options, theme, etc.
  'menu_slug'       => 'cs-framework',
  'menu_position'   => '2',
  'ajax_save'       => false,
  'show_reset_all'  => false,
  'framework_title' => 'MixPro Theme <small>by Anik Ishaan</small>',
);
...
// ----------------------------------------
// This Section Setup For Header Top Area  -
// ----------------------------------------
...
$options[] = array(
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'content',
            'content' => '<p style="font-size: 30px;margin:0;padding: 0;background-color: #444;color:#fff;text-align: center">This Section For Header Area You Can Add These Item.</p>',
        ),
        array(
            'id'     =>'header_title',
            'type'   =>'text',
        ...
        array(
            'id'       =>'header_info',
            'type'     =>'textarea',
            'title'    =>'Header Section Disc',
        ),
        array(
            'id'        =>'header_img',
            'type'      =>'image',
            'title'     =>'Header Section Image',
            'add_title' => "Add Header Image",
        ),
    ),
);
// ----------------------------------------
// This Section Setup For Information Area  -
// ----------------------------------------
$options[]  = array(
    'name'   => 'second_section',
    ...
    'fields' => array(
        array(
            'type'    => 'content',
            'content' => '<p style="font-size: 30px;margin:0;padding: 0;background-color: #444;color:#fff;text-align: center">This Section For Information Area You Can Add These Item.</p>',
        ),
        ...
        array(
            'id'=>'info_disc',
            'type'=>'textarea',
            'title'=>'Info Section Disc',
        ),
    ),
);
// ----------------------------------------
// This Section Setup For About Area  -
// ----------------------------------------
$options[] = array(
    'name' => 'third_section',
    'title' => 'About Area',
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'content',
            'content' => '<p style="font-size: 30px;margin:0;padding: 0;background-color: #444;color:#fff;text-align: center">This Section For About Area You Can Add These Item.</p>',
        ),
        array(
            'id' => 'about_title',
            'type' => 'text',
            'title' => 'About Title',
            'help'    => 'Write something For Your About Title',
            'default' => 'About Me',
        ),
        array(
            'id' => 'about_sub_title',
...
// ----------------------------------------
// This Section Setup For Group Information Area  -
// ----------------------------------------
$options[] = array(
    'name' => 'forth_section',
    ...
    'fields' => array(
        ...
        array(
            'type'    => 'content',
            'content' => '<p style="font-size: 30px;margin:0;padding: 0;background-color: #444;color:#fff;text-align: center">Here You Can Add Your Experience</p>',
        ),
        array(
            'id' => 'group_area_title',
            'type' => 'text',
...
$options[] = array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'experience_skill_bar',
            'type' => 'group',
            'title'           => 'Skill Bar Group Field',
            'button_title'    => 'Add New Item',
            'accordion_title' => 'Add New Field',
            'fields'          => array(
                ...
                array(
                    ...
                    "type" => "text",
                    "title" => "Skill Name",
                    "desc" => "Write Your Skill Name Like HTML, CSS etc"
                ),
                array(
                    "id" => "skill_bar_percent",
                    "type" => "text",
                    "title" => "Skill Name",
                    "desc" => "Write Your Skill Presented min 1 To Max 100 Without % symbol",
                    'attributes'    => array(
                        'maxlength'   => 3,
                        'placeholder' => 'write 1 - 100'
                    )
                ),
            )
        )
